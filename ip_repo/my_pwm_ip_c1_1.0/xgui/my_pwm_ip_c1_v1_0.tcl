...
proc update_PARAM_VALUE.dc_bits { PARAM_VALUE.dc_bits } {
	# Procedure called to update dc_bits when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.dc_bits { PARAM_VALUE.dc_bits } {
	# Procedure called to validate dc_bits
	return true
}
...
proc update_MODELPARAM_VALUE.dc_bits { MODELPARAM_VALUE.dc_bits PARAM_VALUE.dc_bits } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.dc_bits}] ${MODELPARAM_VALUE.dc_bits}
}
